...
export type HypiRootAggregate = Todos | PageInfo | HypiResultEdge | HypiFilterConnection | HypiEnv | Pair | AggInt | AggFloat | AggOtherScalar | Script | RequestTemplate | NotificationCtx | Notification | Url | Currency | Coordinate | GeoEnvelope | Language | Address | PersonName | Phone | Email | Password | RemoteLogin | LoginAttempt | BruteForceDetectionOptions | OAuth2AuthorizedClient | AuthClient | AbacPolicy | AbacTag | Image | EmailVerification | EmailTemplate | EmailSendingAttempt | PasswordReminder | Webhook | WebhookResponse | LogMessage | GraphQlRef | WorkflowStepData | WorkflowStep | AccessToken | StorageCounter | PermissionDescription | Hypi | Country | Account | Person | Organisation | OAuthProvider | Realm | Group | Role | RolePolicy | ClientPolicy | TimePolicy | AggregatedPolicy | GroupPolicy | AccountPolicy | RealmPolicy | RealmLink | Permission | File | Video | EmailMessage | Workflow | WorkflowSession | Counter | Gauge | ServerlessResponse;
...
/** Scalar fields defined by Todos */
export enum TodosScalarFields {
  Id = 'id',
  Title = 'title',
  Description = 'description',
  Completed = 'completed',
...
export type HypiUpsertInputUnion = {
  Todos?: Maybe<Array<TodosInputOpt>>;
...
export type TodosGroupByOptions = {
  /** The field by which to to group the matching data */
  field: TodosScalarFields;
  /** If provided, the aggregated data will be ordered by this field and any other field which specifies this field, in the order they're defined */
  order?: Maybe<AggOrder>;
  /** Applies only to DateTime fields. If provided then the date is grouped to this granularity e.g. if MINUTES then the grouping will be per minute */
  dateGranularity?: Maybe<TimeUnit>;
...
/** All numeric fields defined by Todos */
export enum TodosNumericFields {
  Id = 'id'
}
...
export type HypiAggregationType = {
  ...
  todos?: Maybe<TodosAggs>;
  todosWith?: Maybe<Array<Maybe<TodosAggs>>>;
...
/** A list of types on which aggregation queries can be executed */
export type HypiAggregationTypeTodosArgs = {
  where?: Maybe<Scalars['String']>;
};


/** A list of types on which aggregation queries can be executed */
export type HypiAggregationTypeTodosWithArgs = {
  where?: Maybe<Scalars['String']>;
  groupBy: Array<TodosGroupByOptions>;
...
export type TodosAggs = {
  __typename?: 'TodosAggs';
  id?: Maybe<AggInt>;
  title?: Maybe<AggOtherScalar>;
  description?: Maybe<AggOtherScalar>;
  completed?: Maybe<AggOtherScalar>;
  hypi_id?: Maybe<AggOtherScalar>;
  hypi_impl?: Maybe<AggOtherScalar>;
  hypi_created?: Maybe<AggOtherScalar>;
  hypi_updated?: Maybe<AggOtherScalar>;
...
export type TodosMaths = {
  id?: Maybe<MathInputInt>;
};
...
export type LoginByEmailQueryVariables = Exact<{
  email: Scalars['String'];
  password: Scalars['String'];
}>;


export type LoginByEmailQuery = (
  { __typename?: 'Query' }
  & { loginByEmail?: Maybe<(
    { __typename?: 'AccessToken' }
    & Pick<AccessToken, 'sessionToken' | 'sessionExpires' | 'errorCode' | 'errorMsg'>
  )> }
);
...
export type CreateAccountMutation = (
  ...
  & { createAccount?: Maybe<(
    { __typename?: 'Hypi' }
    & Pick<Hypi, 'id' | 'created' | 'createdBy'>
  )> }
);
...
export const LoginByEmailDocument = gql`
  ...
  export class LoginByEmailQueryService extends Apollo.Query<LoginByEmailQuery, LoginByEmailQueryVariables> {
    document = LoginByEmailDocument;
...
export const CreateAccountDocument = gql`
  ...
  createAccount(
    value: {username: $username, password: {value: $password}, emails: [{value: $email}]}
  ) {
    id
    created
    createdBy
  ...
  export class CreateAccountMutationService extends Apollo.Mutation<CreateAccountMutation, CreateAccountMutationVariables> {
...
export const DeleteDocument = gql`
  ...
  delete(type: Todos, arcql: $arcql, clearArrayReferences: $clearArrayReferences)
}
    `;
...
export const GetTodoDocument = gql`
  ...
  export class GetTodoQueryService extends Apollo.Query<GetTodoQuery, GetTodoQueryVariables> {
    document = GetTodoDocument;
...
export const TodosDocument = gql`
  ...
  export class TodosQueryService extends Apollo.Query<TodosQuery, TodosQueryVariables> {
